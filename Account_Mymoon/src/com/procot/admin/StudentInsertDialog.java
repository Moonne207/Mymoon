 ...
 * @author Admin
 */
public class StudentInsertDialog extends javax.swing.JFrame {
    StudentForm panel;
     ...
     */
    public StudentInsertDialog(StudentForm panel) {
        initComponents();
        this.panel = panel;
    ...
    public void insert(){
        ...
        if(isValidInput()){
            ...
            Student st = new Student(fullName , dateOfBirth , gender , address , phoneNumber , email , classID);
            ...
            ModalDialog.closeModal("StudentInsert");
        }
    }
