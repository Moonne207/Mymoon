...
public class LecturerUpdateDialog extends javax.swing.JFrame {
     ...
     */
    public LecturerUpdateDialog(LecturerForm panel) {
        initComponents();
        this.panel = panel;
        loadComboBox();
        displayData();
    ...
    public void displayData(){
        ...
        txtaAddress.setText(lr.getAddress());
        cboChooseMajor.setSelectedItem(lr.getMajorName());
        txtStatus.setText(lr.getStatus()); 
    }
    ...
    // Kiểm tra định dạng số điện thoại + sự tồn tại
    ...
    public void update() {
        ...
        if (isValidInput()) {
            ...
            int lecturerID = panel.getSelected().getLecturerID();
            ...
            ModalDialog.closeModal("LecturerUpdate");
        }
    }
