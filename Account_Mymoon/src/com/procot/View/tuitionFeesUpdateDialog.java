 ...
 * @author skmyg
 */
public class tuitionFeesUpdateDialog extends javax.swing.JPanel {
    ...
    if (isValidInput()) { 
        ...
        am.setAccountName(txtAccountName.getText());
        ...
        if (result > 0) {
            ...
            Toast.show(panel, Toast.Type.SUCCESS, "Update successful!");
            ModalDialog.closeModal("accountUpdate"); // ✅ Đóng form cập nhật
        } else {
            Toast.show(panel, Toast.Type.ERROR, "Update failed! Email may already exist.");
        }
    } 
}
    /**
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cbxRole, 0, 142, Short.MAX_VALUE)
