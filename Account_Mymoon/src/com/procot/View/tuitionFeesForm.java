 ...
 * @author skmyg
 */
public class tuitionFeesForm extends javax.swing.JPanel {
    ...
    tableUtil.rendererTable(tblTuitionFees); // Căn chỉnh dữ liệu trong bảng
    tblTuitionFees.setAutoCreateRowSorter(true); // Tự động sắp xếp theo thứ tự [A-Z] và ngược lại
        ...
        lblTotal.setText("Số lượng: " + tuitionList.size()); // Tính só lượng dự liệu
    ...
    public void openInsertDialog() {
        ...
        ModalDialog.showModal(this, new SimpleModalBorder(new tuitionFeesInsertDialog(this), nameTitle), option, "TuitionFeesInsert");
    }

    // Phương thức mở bản sửa dự liệu
    public void openUpdateDialog() {
        // Sử dụng thư viện swing modal của DJ Raven
        if (tblTuitionFees.getSelectedRow() == -1) {
    ...
    private void initComponents() {
        ...
        tblTuitionFees = new javax.swing.JTable();
        lblTotal = new javax.swing.JLabel();

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setText("Thông tin học phí");
        ...
        tblTuitionFees.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblTuitionFees);
        if (tblTuitionFees.getColumnModel().getColumnCount() > 0) {
            tblTuitionFees.getColumnModel().getColumn(0).setMaxWidth(40);
        }
    ...
    private javax.swing.JTable tblTuitionFees;
