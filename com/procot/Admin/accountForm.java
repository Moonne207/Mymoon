...
public class accountForm extends javax.swing.JPanel {
    ...
    public void loadTableAll() {
        String[] column = new String[]{"Fullname","Username", "Email","Password","Role","Student","Lecturer"};   // Ghi tên bạn muốn cho từng column table
    ...
    public void openUpdateDialog() {
        ...
        if (tblAccount.getSelectedRow() == -1) {
            Toast.show(this, Toast.Type.WARNING, "Please select a user to edit");
        } else {
            // Tạo option cho ModalDialog
            Option option = ModalDialog.createOption();
